...
$sql_count_or = mysqli_query($conn, "SELECT COUNT(id_borrow) AS NumberCon FROM borrows WHERE deleteOn = 0; ");
$count_or = mysqli_fetch_assoc($sql_count_or);
$count_order = (int)$count_or['NumberCon'];

$sql_count_b = mysqli_query($conn, "SELECT COUNT(id_borrow) AS NumberCon FROM borrows WHERE deleteOn = 1; ");
$count_bin = mysqli_fetch_assoc($sql_count_b);
$count = (int)$count_bin['NumberCon'];
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex"  >
                            <h3 class="card-title"> Các đơn mượn(<?php echo $count_order?>)</h3>
                           
                            <h3 class="card-title ml-5" ><a href="index.php?action=quan-ly-muon-sach&query=thung-rac">Thùng rác(<?php echo $count?>)</a></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
