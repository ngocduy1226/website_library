                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex" style="justify-content: space-between;">
                            <h3 class="card-title"> Thùng rác(<?php echo $count_comment_bin ?>)</h3>

                            <h3 class="card-title ml-5"><a href="index.php?action=quan-ly-danh-binh-luan&query=danh-sach">Danh sách( <?php echo   $count_comment ?>)</a></h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <a class="btn btn-danger ml-1" onclick="return Restore('<?php echo $row['id_CMT'] ?>')" href="index.php?action=quan-ly-binh-luan&query=khoi-phuc&id_CMT=<?php echo $row['id_CMT'] ?>"><i class="fa-sharp fa-solid fa-trash-can-arrow-up"></i></a>
                                            </td>
                                        </tr>
...
<script>
    function Restore(name) {
        return confirm("Bạn có chắc chắn muốn khôi phục bình luận: " + name + "?");
    }
</script>