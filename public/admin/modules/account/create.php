...
if (isset($_POST['sbm_add'])) {
    ...
    if (empty($err)) {
        ...
        if ($query) {
            echo '<script language="javascript">alert("Bạn đã thêm thành viên thành công!"); window.location="index.php?action=quan-ly-thanh-vien&query=danh-sach";</script>';
        }
    }
}
                            ...
                            <form method="POST" enctype="multipart/form-data" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" value="<?php if (isset($email)) {
                                                                    echo $email;
                                                                }; ?>" name="email" class="form-control" require>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" value="<?php if (isset($password)) {
                                                                        echo $password;
                                                                    }; ?>" name="password" class="form-control" require>
                                    <span class="erro"><?php echo (isset($err['password'])) ? $err['password'] : '' ?></span>
                                </div>

                                <div class="form-group">
                                    <label for="">Nhập lại mật khẩu</label>
                                    <input type="password" value="<?php if (isset($repassword)) {
                                                                        echo $repassword;
                                                                    }; ?>" name="repassword" class="form-control" require>
